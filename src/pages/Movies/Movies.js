...
const Movies = () => {
  ...
  const fetchMovies = async () => {
    const { data } = await axios.get(`${process.env.REACT_APP_DISCOVER_MOVIE}${process.env.REACT_APP_APIKEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${genreURL}`)
